...
Displays an animated rotation of the latest tweets on a given account via a widget or a shortcode such as [rotatingtweets screen_name='your_twitter_name'] 
